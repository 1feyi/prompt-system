...
class StudentTestsView extends StatelessWidget {
  const StudentTestsView({super.key});

  // Helper function to group test entries by date
  Map<String, List<Map<String, dynamic>>> _groupByDate(List<Map<String, dynamic>> tests) {
    Map<String, List<Map<String, dynamic>>> grouped = {};
    for (var entry in tests) {
  ...
  Widget build(BuildContext context) {
    // Example test data - this would come from the admin in a real app
    final List<Map<String, dynamic>> tests = [
      {'course': 'CSC 101', 'date': '2024-04-15', 'time': '10:00 AM', 'venue': 'COCCS LAB'},
    ...
    final groupedTests = _groupByDate(tests);
    final sortedDates = groupedTests.keys.toList()..sort();
      ...
      body: Padding(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, dateIndex) {
            ...
            final dateEntries = groupedTests[date] ?? [];
